...
class SellerPropertyVideoUploadModule extends StatelessWidget {
  SellerPropertyVideoUploadModule({Key? key}) : super(key: key);
  final screenController = Get.find<AddPropertyImageScreenController>();
  final ImagePicker imagePicker = ImagePicker();
...
class SellerPropertyVideoShowModule extends StatelessWidget {
  SellerPropertyVideoShowModule({Key? key}) : super(key: key);
  final screenController = Get.find<AddPropertyImageScreenController>();
...
class SellerProjectVideoUploadModule extends StatelessWidget {
  SellerProjectVideoUploadModule({Key? key}) : super(key: key);
  final screenController = Get.find<AddPropertyImageScreenController>();
  final ImagePicker imagePicker = ImagePicker();
...
class SellerProjectVideoLinkListModule extends StatelessWidget {
  SellerProjectVideoLinkListModule({Key? key}) : super(key: key);
  final screenController = Get.find<AddPropertyImageScreenController>();

  @override
  Widget build(BuildContext context) {
    return screenController.propertyYtLinkList.isEmpty
        ? const Text("No youtube links available!")
        : ListView.builder(
