...
class AddPropertyImageScreenController extends GetxController {
  ...
  Future<void> addPropertyImagesFunction() async {
    isLoading(true);
    String url = ApiUrl.addSellerPropertyImagesApi;
  ...
  Future<void> getPropertyImagesFunction() async {
    isLoading(true);
    String url = ApiUrl.getSellerPropertyImagesApi;
  ...
  Future<void> deletePropertyImageFunction(int id) async {
    isLoading(true);
    String url = ApiUrl.deleteSellerPropertyImageApi;
  ...
  Future<void> uploadYoutubeLinkFunction() async {
    isLoading(true);
    String url = ApiUrl.addSellerPropertyYoutubeLinkApi;
  ...
  Future<void> getPropertyYoutubeLinkFunction() async {
    isLoading(true);
    String url = ApiUrl.getSellerPropertyYoutubeLinkApi;
  ...
  Future<void> deletePropertyYoutubeLinkFunction({required int id}) async {
    isLoading(true);
    String url = ApiUrl.deleteSellerPropertyYoutubeLinkApi;
