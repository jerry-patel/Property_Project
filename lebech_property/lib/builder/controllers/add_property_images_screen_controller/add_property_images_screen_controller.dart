...
class AddBuilderPropertyImagesScreenController extends GetxController {
  ...
  Future<void> getPropertyImagesFunction() async {
    isLoading(true);
    String url = ApiUrl.getPropertyImageListApi;
  ...
  Future<void> addPropertyImagesFunction() async {
    isLoading(true);
    String url = ApiUrl.addBuilderPropertyImagesApi;
  ...
  Future<void> deletePropertyImageFunction(int id) async {
    isLoading(true);
    String url = ApiUrl.deletePropertyImageApi;
  ...
  /// Get Property Video Functions
  Future<void> getProjectVideoFunction() async {
    isLoading(true);
    String url = ApiUrl.builderGetPropertyVideoApi;
  ...
  Future<void> uploadPropertyVideoFunction() async {
    isLoading(true);
    String url = ApiUrl.builderUploadPropertyVideoApi;
  ...
  /// Get Property Yt Link Functions
