...
class BrokerImagesGridViewModule extends StatelessWidget {
  BrokerImagesGridViewModule({Key? key}) : super(key: key);
  final screenController = Get.find<AddBrokerPropertyImageScreenController>();
...
class BrokerPropertyYtLinkUploadModule extends StatelessWidget {
  BrokerPropertyYtLinkUploadModule({Key? key}) : super(key: key);
  final screenController = Get.find<AddBrokerPropertyImageScreenController>();
  final ImagePicker imagePicker = ImagePicker();
